...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Rectangle rectMinimap = new Rectangle(World.mapwx/5.0, World.mapwy/5.0, Color.WHITE);
        rectMinimap.setStroke(Color.BLACK);
        rectMinimap.setStrokeWidth(5.0);
        miniGroup.getChildren().add(rectMinimap);
        ...
        miniGroup.setLayoutX(100.0);
        miniGroup.setLayoutY(500.0);
        group2.getChildren().add(miniGroup);
        ...
        scene.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent event) {
                ...
                if (event.isControlDown())
                {
                    ...
                    Main.miniRect.setX(-xloc*Main.SCALE);
                    Main.miniRect.setY(-yloc*Main.SCALE);
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if( !gflg ) {
                    ...
                    System.out.println("Screen sizes"+primaryStage.getWidth() + " "+primaryStage.getHeight());
                    miniRect= new Rectangle(primaryStage.getWidth()/5.0, primaryStage.getHeight()/5.0, Color.TRANSPARENT);
                    miniRect.setStroke(Color.RED);
                    miniRect.setStrokeWidth(2.0);
                    miniGroup.getChildren().add(miniRect);
