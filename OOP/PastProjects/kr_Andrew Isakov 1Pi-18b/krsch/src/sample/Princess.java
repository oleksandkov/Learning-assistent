...
public class Princess extends Drago {
    //   Princess [] peers = new Princess[10];
    Princess(boolean active,boolean side,double x, double y, double s) throws FileNotFoundException {
        super(active, side, x, y, s);
        this.i = new Image(new FileInputStream("src/images/princess.png"));
...
// relocating
     ...
     Princess() throws FileNotFoundException {
         super();
         this.i = new Image(new FileInputStream("src/images/princess.png"));
//speed.setSpeed(3);
        ImageView imageView = new ImageView(i);
