...
async function seedLookups() {
  const subjects = ['Вища Математика', 'ООП', 'Фізика', 'Людино-машинна взаємодія', 'АВ ПЗ'];
  const groups = ['2ПІ-25Б', '3ПІ-25Б', '1ПІ-25Б'];
  const teachers = ['Іваненко І.І.', 'Петренко О.В.', 'Коваль М.С.', 'Ткаченко О.М.'];
...
async function seedLessons() {
  ...
  const seed = [
    ['Вища Математика', 'Пн', '08:30', '201', '2ПІ-25Б', '1', 'Іваненко І.І.', 'Лекція'],
    ['ООП', 'Вт', '10:15', '302', '2ПІ-25Б', 'Обидва', 'Петренко О.В.', 'Практика'],
    ['Фізика', 'Ср', '13:45', '105', '3ПІ-25Б', '2', 'Коваль М.С.', 'Лабораторна'],
    ['АВ ПЗ', 'Чт', '08:30', '210', '1ПІ-25Б', '1', 'Іваненко І.І.', 'Лекція'],
    ['Людино-машинна взаємодія', 'Ср', '14:00', '2320', '2ПІ-25Б', '1', 'Ткаченко О.М.', 'Лекція']
  ];
